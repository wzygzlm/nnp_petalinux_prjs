...
/* Definitions for peripheral AXI_GPIO_RST */
#define XPAR_AXI_GPIO_RST_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_RST_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_RST_DEVICE_ID 2
#define XPAR_AXI_GPIO_RST_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_RST_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_RST_GENERAL */
#define XPAR_AXI_GPIO_RST_GENERAL_BASEADDR 0x41230000
#define XPAR_AXI_GPIO_RST_GENERAL_HIGHADDR 0x4123FFFF
#define XPAR_AXI_GPIO_RST_GENERAL_DEVICE_ID 3
#define XPAR_AXI_GPIO_RST_GENERAL_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_RST_GENERAL_IS_DUAL 0
...
/* Canonical definitions for peripheral AXI_GPIO_RST */
#define XPAR_GPIO_2_BASEADDR 0x41200000
#define XPAR_GPIO_2_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_AXI_GPIO_RST_DEVICE_ID
#define XPAR_GPIO_2_INTERRUPT_PRESENT 0
#define XPAR_GPIO_2_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_RST_GENERAL */
#define XPAR_GPIO_3_BASEADDR 0x41230000
#define XPAR_GPIO_3_HIGHADDR 0x4123FFFF
#define XPAR_GPIO_3_DEVICE_ID XPAR_AXI_GPIO_RST_GENERAL_DEVICE_ID
